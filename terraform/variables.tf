locals {
  config = {
    ...
    staging = {
      ...
      resource_domain              = "review.swiswiswift.com"
      ...
      resource_acn_certificate_arn = "arn:aws:acm:us-east-1:772281501799:certificate/041caa0c-a884-4ef9-a746-2a1db6b8a28c"
